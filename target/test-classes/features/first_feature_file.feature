...
#  When -> should be used in the middle steps. When steps are
#          used to describe an event, or an action.
#  And -> should be used in the middle steps
#  We can use more than one Scenario: in a feature file
#  Each step must begin with a Gherkin keyword


  Background: opening_google_page
    Given user is on the google page
# Background keyword declares all scenarios has same steps.
#        It executes for each scenario.
#        So, no need to write this step in every scenarios.
