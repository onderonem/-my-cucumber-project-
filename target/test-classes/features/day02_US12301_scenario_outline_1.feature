...
# Scenario Outline is used for DDT-Data Driven testing.
#                    This is similar to testing with excel sheet
# Scenario Outline makes feature files shorter and cleaner, it avoids from repetition